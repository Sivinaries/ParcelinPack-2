                                ...
                                <div className="h-full flex justify-center">
                                    <Slider className="w-full h-full" {...settings}>
                                        {[
                                            ...
                                            <div key={index} className="h-full w-fit flex justify-center min-h-[24px] md:min-h-[100px]">
                                                <h1 className="text-[13px] md:text-[70px] font-extralight text-black flex items-center">
                                                    {item}
                                                    <img src={star} alt="Running Star" className="mx-3 md:mx-6 h-4 xl:h-10" />
                                                </h1>
                                            </div>
                                        ))}
                                    </Slider>
