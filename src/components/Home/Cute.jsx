      ...
      <div className="md:my-auto my-4 grid md:grid-cols-2">
        <div className="md:w-5/6 md:mx-auto space-y-4 my-auto order-2 md:order-none">
          <div>
            ...
            >
              Temukan kebutuhan packaging untuk berbagai industri di
              Parcelinpack. Buat kemasan menarik, dan tingkatkan value bisnismu.
            </h1>
          </div>
          <div className="p-2 md:p-3 bg-orange-500 w-1/2 md:w-1/4 rounded-full md:order-none order-1">
            <a href="">
              <h1 className="flex items-center justify-between p-2 text-white text-center text-lg md:text-xl">
                Lihat Produk <LuArrowUpRight className="md:hidden" size={24} />
              </h1>
            </a>
          </div>
        </div>
