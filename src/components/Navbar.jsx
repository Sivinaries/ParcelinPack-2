...
export default function Navbar() {
  ...
  useEffect(() => {
    const checkActivePath = () => {
      ...
      if (currentPath.startsWith("/service/6")) {
        const productLink = navLinks.find((link) => link.to === "/service/6");
        setActivePage(productLink);
      } else {
    ...
    const interval = setInterval(checkActivePath, 100);
